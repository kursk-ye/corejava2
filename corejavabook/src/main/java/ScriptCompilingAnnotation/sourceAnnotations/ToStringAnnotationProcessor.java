...
@SupportedAnnotationTypes("ScriptCompilingAnnotation.sourceAnnotations.ToString")
...
public class ToStringAnnotationProcessor extends AbstractProcessor
{
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment currentRound)
  {
    ...
    try
    {
      JavaFileObject sourceFile = processingEnv.getFiler().createSourceFile("ScriptCompilingAnnotation.sourceAnnotations.ToStrings");
      PrintWriter out = new PrintWriter(sourceFile.openWriter());
      out.println("// Automatically generated by sourceAnnotations.ToStringAnnotationProcessor");
      out.println("package ScriptCompilingAnnotation.sourceAnnotations;");
